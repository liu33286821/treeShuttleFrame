        ...
        <template>
            ...
            <div class="transfer-left">
                <h3 class="transfer-title">
                    ...
                    <span>{{fromTitle}}</span>
                    <p class="length">{{checkedFromDataLength}}/{{formDataLength}}</p>
                </h3>
                <!-- 内容区 -->
            ...
            <div class="transfer-right">
                <h3 class="transfer-title">
                    ...
                    <span>{{toTitle}}</span>
                    <p class="length">{{checkedToDataLength}}/{{toDataLength}}</p>
                </h3>
                <!-- 内容区 -->
                <div class="transfer-main">
                    ...
                    <el-tree slot='to'
                             ...
                             <span v-if="node.isLeaf">
                                    <el-select v-model="node.data.region">
                                    <el-option label="交易日期" value="1"/>
                                    <el-option label="费用归属月" value="2"/>
                                </el-select>
                                </span>
                        </span>
                    </el-tree>
    ...
    export default {
        ...
        methods: {
            ...
            addToAims() {
                ...
                this.checkedFromDataLength = 0;//清空成0
            ...
            removeToSource() {
                ...
                this.checkedToDataLength = 0;//清空成0
            ...
            fromTreeChecked(nodeObj, treeObj) {
                this.checkedFromDataLength = 0
                this.from_check_keys = treeObj.checkedNodes;
                console.log(treeObj,nodeObj, this.from_check_keys )
                for (let i = 0; i < treeObj.checkedNodes.length; i++) {
                    if (!treeObj.checkedNodes[i].children.length) {
                        this.checkedFromDataLength++
                    }
                }
            },
            // 目标树选中事件 - 是否禁用穿梭按钮
        ...
        computed: {
            ...
            toDataLength() {
                ...
                return getLeafCountTree(this.to_data[0]) || 0;
            },
            formDataLength() {
                function getLeafCountTree(json) {
                    if (json) {
                ...
                return getLeafCountTree(this.self_from_data[0]) || 0;
            },
            // 左侧数据
            self_from_data() {
...
<style>
    .transfer .el-tree-node__content {
        height: 40px;
    }

    .transfer .el-checkbox__inner {
        top: 4px;
    }

    .transfer .el-tree-node__content .el-select {
